...
const ImageModal = ({ imageModalOpened, closeImageModal, selectedArtboard, canvasRef, artboardRef }: ImageModalProps) => {
    ...
    return (
        ...
        >
            <Tabs defaultValue="url">
                <Tabs.List>
                    <Tabs.Tab value="url" icon={<IconPhoto size="0.8rem" />}>From URL</Tabs.Tab>
                    <Tabs.Tab value="upload" icon={<IconLinkPlus size="0.8rem" />}>Upload</Tabs.Tab>
                    <Tabs.Tab value="unsplash" icon={<IconSettings size="0.8rem" />}>Unsplash Random</Tabs.Tab>
                </Tabs.List>
                ...
                <Tabs.Panel value="upload" pt="xs">
                    <Stack spacing={"lg"}>
                        <FileInput multiple onChange={(files) => {
                            console.log(files)
                            files.forEach((file) => {
                        ...
                        }} label="Upload Images" placeholder="Select Images for upload" icon={<IconUpload size="0.8rem" />} />
                        <Button onClick={() => {
                            closeImageModal()
                        }
                        }>Close</Button>
                ...
                <Tabs.Panel value="unsplash" pt="xs">
                    <Stack spacing={"lg"}>
                        <Button onClick={() => {
                            ...
                            closeImageModal()
                        }}>Add Random From Unsplash</Button>
                    </Stack>
                </Tabs.Panel>
            </Tabs>
        </Modal >
